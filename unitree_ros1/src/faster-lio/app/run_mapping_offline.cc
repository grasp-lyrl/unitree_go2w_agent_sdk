...
DEFINE_string(config_file, "/home/unitree/unitree_ros1/src/faster-lio/config/hesai.yaml", "path to config file");
DEFINE_string(bag_file, "/home/unitree/agh-office-ros1.bag", "path to the ros bag");
DEFINE_string(time_log_file, "/home/unitree/unitree_ros1/src/faster-lio/time.log", "path to time log file");
DEFINE_string(traj_log_file, "/home/unitree/unitree_ros1/src/faster-lio/traj.txt", "path to traj log file");
